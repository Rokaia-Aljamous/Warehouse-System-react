...
const proxyRoutes: Record<string, ProxyOptions> = {
  ...
  "^/([^/]+)/(?:owner/)?(login|logout|me|warehouses|products|shipments|drivers|force-password-change|forgot-password|reset-password|manager|storekeeper|keeper|analytics|inventory-movements)(/.*)?$": laravelProxy(),
};
